...
**เหลืองานเดียว: ทดสอบบนเครื่องจริง** — เป็นหนี้ก้อนเดียวที่เป็นความเสี่ยงจริง
ทุกอย่างผ่านเทสต์ระดับ host แต่ยังไม่เคยเห็นค่าจากเซ็นเซอร์จริงสักครั้ง เช็กลิสต์:
...
รันครั้งสุดท้ายที่ head `6fe1fbc` · ไม่มีเทสต์ตัวไหนถูกลบ ปิด หรือ `@Ignore`
