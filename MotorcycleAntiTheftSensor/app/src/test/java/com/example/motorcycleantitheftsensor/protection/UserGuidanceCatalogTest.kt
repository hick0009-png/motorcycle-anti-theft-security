...
class UserGuidanceCatalogTest {
    ...
    fun `Verify exhaustive mapping`() {
        ...
        assertEquals("กำลังเปิดการป้องกัน…", c_COMMAND_ARM_APPLIED.titleTh)
        ...
        assertEquals("banner + action จาก reason", c_COMMAND_ARM_REJECTED.titleTh)
        assertEquals("banner + action จาก reason", c_COMMAND_ARM_REJECTED.bodyTh)
        ...
        assertEquals("banner + action จาก reason", c_COMMAND_DISARM_REJECTED.titleTh)
        assertEquals("banner + action จาก reason", c_COMMAND_DISARM_REJECTED.bodyTh)
        ...
        assertEquals("ไม่มี", c_COMMAND_UNKNOWN.titleTh)
        ...
        assertEquals("🚨 เหตุการณ์รุนแรงขึ้น: ", c_INCIDENT_ESCALATED.telegramTh)
